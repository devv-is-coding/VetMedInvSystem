...
$routes->scope('/api', ['prefix' => 'Api'], function (RouteBuilder $builder) {
    ...
    // PetOwner routes
    $builder->connect('/petowner', [
        'controller' => 'PetOwner',
        'action' => 'index',
        '_namespace' => 'App\Controller\Api',
    ]);
    $builder->connect('/petowner/view/:id', [
        'controller' => 'PetOwner',
        'action' => 'view',
        '_namespace' => 'App\Controller\Api',
    ])->setPass(['id']);

    $builder->connect('/petowner/add', [
        'controller' => 'PetOwner',
        'action' => 'add',
        '_namespace' => 'App\Controller\Api',
    ]);
    $builder->connect('/petowner/edit/:id', [
        'controller' => 'PetOwner',
        'action' => 'edit',
        '_namespace' => 'App\Controller\Api',
    ])->setPass(['id'])->setPatterns(['id' => '\d+']);

    $builder->connect('/petowner/delete/:id', [
        'controller' => 'PetOwner',
        'action' => 'delete',
        '_namespace' => 'App\Controller\Api',
    ])->setPass(['id']);
